...
try {
    ...
    $applicationQuery = "
    SELECT 
        ja.application_id, ja.status, jp.job_title, jp.job_type, jp.job_mode, jp.job_id,
            ...
            <tbody class="text-center">
                <?php foreach ($applications as $index => $application) : ?>
                    <tr>
                        ...
                        <td>
                            <?php if ($application['status'] !== 'Approved' && $application['status'] !== 'Done') : ?>
                                <a href="../Process/cancel_job_application.php?job_id=<?php echo urlencode($application['job_id']); ?>" class="btn btn-danger me-2">
                                    <i class="bi bi-x-circle"></i> Cancel Job Application
                                </a>
                            <?php else : ?>
                                <a href="#" class="btn border me-2" style="background-color:#cf576b;color:white;" title="You can't Withdraw Application Because Your work is Already Assigned And Approved By Employer">
                                    <i class="bi bi-x-circle"></i> Cancel Job Application
                                </a>
                            <?php endif; ?>
                        </td>
